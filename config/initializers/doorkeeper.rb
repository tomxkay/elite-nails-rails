...
Doorkeeper.configure do
  ...
  # Single owner → no need to show a consent screen; approve once logged in.
  skip_authorization do
    true
  end

  # OAuth 2.1 for MCP: authorization-code flow only, PKCE (S256) required for the
  # public clients Claude registers, with refresh tokens.
